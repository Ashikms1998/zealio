        ...
        <div className="absolute bg-opacity-70 w-screen h-screen top-0 bottom-0 flex flex-col items-center justify-center bg-black">
          ...
          <div className="mt-8 flex items-center justify-center">
            <button onClick={toggleMic}>
              {!isMicOn && <MdMicOff className="text-white" size={28} />}{" "}
              {isMicOn && <MdMic className="text-white" size={28} />}
            </button>
            <button
            ...
            <button onClick={toggleCamera}>
              {!isVideoOn && <MdVideocamOff className="text-white" size={28} />}{" "}
              {isVideoOn && <MdVideocam className="text-white" size={28} />}
            </button>
          </div>
        </div>
      )}
